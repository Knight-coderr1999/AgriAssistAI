...
try:
    from agentic_int import Gemma3nCropDiseaseAnalysis
except ImportError as e:
    print(f"Warning: Could not import CropDiseaseAnalyzer: {e}")
    Gemma3nCropDiseaseAnalysis = None
...
try:
    from speech_service import Gemma3nSTTService
except ImportError as e:
    print(f"Warning: Could not import ChirpSTTService: {e}")
    Gemma3nSTTService = None
...
def analyze_crop():
    ...
    try:
        if Gemma3nCropDiseaseAnalysis:
            analyzer = Gemma3nCropDiseaseAnalysis()
...
def speech_to_text():
    ...
    try:
        if Gemma3nSTTService:
            stt_service = Gemma3nSTTService(file_ext=file_ext)
